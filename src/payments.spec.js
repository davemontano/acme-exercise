...
describe("payments", () => {
    ...
    it('should return the final payment for a single person', () => {
        ...
        const input = "MOE=MO06:00-11:00,WE18:00-22:00,TH02:00-05:00,SA13:00-14:00,SU10:00-12:00"
    ...
    it('should show on console the pay for a single person', () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith("The amount to pay ASTRID is: 85 USD")
    })
